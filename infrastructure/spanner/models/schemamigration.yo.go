...
func SchemaMigrationWritableColumns() []string {
	return []string{
		"Version",
		"Dirty",
	}
...
func (sm *SchemaMigration) Insert(ctx context.Context) *spanner.Mutation {
	values, _ := sm.columnsToValues(SchemaMigrationWritableColumns())
	return spanner.Insert("SchemaMigrations", SchemaMigrationWritableColumns(), values)
}
...
func (sm *SchemaMigration) Update(ctx context.Context) *spanner.Mutation {
	values, _ := sm.columnsToValues(SchemaMigrationWritableColumns())
	return spanner.Update("SchemaMigrations", SchemaMigrationWritableColumns(), values)
}
...
func (sm *SchemaMigration) InsertOrUpdate(ctx context.Context) *spanner.Mutation {
	values, _ := sm.columnsToValues(SchemaMigrationWritableColumns())
	return spanner.InsertOrUpdate("SchemaMigrations", SchemaMigrationWritableColumns(), values)
}
